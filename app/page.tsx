...
export default function Home() {
  const emotions = [
    { value: 0, label: "😔 Bajo", color: "from-blue-500/50" },
    { value: 25, label: "😊 Contento", color: "from-green-500/50" },
    { value: 50, label: "😌 Pacífico", color: "from-purple-500/50" },
    { value: 75, label: "🤗 Feliz", color: "from-yellow-500/50" },
    { value: 100, label: "✨ Emocionado", color: "from-pink-500/50" },
  ];
  ...
  const welcomeSteps = [
    {
      title: "Hola, soy Armi 👋",
      description:
        "Tu compañero de IA para el bienestar emocional. Estoy aquí para ofrecerte un espacio seguro y sin prejuicios donde puedas expresarte.",
      icon: Waves,
    },
    {
      title: "Soporte personalizado 🌱",
      description:
        "Me adapto a tus necesidades y estado emocional, ofreciendo técnicas basadas en evidencia y orientación amable cuando más lo necesitas.",
      icon: Brain,
    },
    {
      title: "Tu privacidad importa 🛡️",
      description:
        "Nuestras conversaciones son completamente privadas y seguras. Sigo estrictas normas éticas y respeto tus límites.",
      icon: Shield,
    },
  ];
  ...
  const features = [
    {
      icon: HeartPulse,
      title: "Soporte 24/7",
      description: "Siempre aquí para escucharte y apoyarte, en cualquier momento del día.",
    ...
    },
    {
      ...
      description: "Orientación personalizada impulsada por la inteligencia emocional",
    ...
    },
    {
      ...
      description: "Tus conversaciones siempre serán confidenciales y encriptadas",
    ...
    },
    {
      ...
      description: "Técnicas terapéuticas respaldadas por la investigación clínica",
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-sm border border-primary/20 bg-primary/5 backdrop-blur-sm hover:border-primary/40 transition-all duration-300">
            ...
            <span className="relative text-foreground/90 dark:text-foreground after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-full after:h-[1px] after:bg-primary/30 after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300">
              Su compañero de salud mental, un agente de IA
            </span>
          </div>
          ...
          <p className="max-w-[600px] mx-auto text-base md:text-lg text-muted-foreground leading-relaxed tracking-wide">
            Experimenta una nueva forma de apoyo emocional. Nuestra IA está aquí para escucharte, comprenderte y guiarte en tu camino.
          </p>
          ...
          >
            <div className="space-y-2 text-center">
              <p className="text-sm text-muted-foreground/80 font-medium">
                Sea lo que sea que estés sintiendo, estamos aquí para escucharte.
              </p>
            ...
            <div className="text-center">
              <p className="text-sm text-muted-foreground animate-pulse">
                Desliza para expresar cómo te sientes hoy
              </p>
            </div>
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto">
          <motion.div className="text-center mb-16 space-y-4 text-white ">
            ...
            <p className="text-foreground dark:text-foreground/95 max-w-2xl mx-auto font-medium text-lg">
              Experimente un nuevo tipo de apoyo emocional, impulsado por IA empática.
            </p>
          </motion.div>
